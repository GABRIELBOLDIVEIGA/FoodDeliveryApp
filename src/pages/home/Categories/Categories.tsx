  ...
  return (
    <section className="pt-6">
      <div className="flex justify-between items-center tracking-wider pb-4">
        ...
        <Button variant="link" className="font-semibold">{t('categoriesHome.link')}</Button>
      </div>
      ...
      <div className="flex w-full gap-2 ">
        {loading &&
          <div className="w-full flex">
            {[1, 2, 3].map((index) => {
              return (
                <div key={index} className="w-1/3 flex flex-col gap-3 justify-center items-center rounded-md ">
