...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 z-10 flex justify-between bg-background w-full shadow-md px-4 py-3">
      ...
      <h3 className="font-bold tracking-wider">Produtos</h3>
...
const CardProduct = (product: Product) => {
  ...
  return (
    <div className="flex gap-2 rounded-xl p-2 shadow-md bg-primary">
      ...
      <div className={cn(`flex w-[190px] h-[120px] rounded-xl bg-zinc-500`)}>
        <img
      ...
      <div className="flex flex-col justify-between w-1/2">
        ...
        <div className="w-full flex justify-between items-center rounded-md bg-secondary dark:bg-secondary-foreground">
          <Button size="icon" className="bg-transparent dark:text-secondary text-secondary-foreground"><Minus /></Button>
          <p className="dark:text-secondary font-semibold">32</p>
          <Button size="icon" className="bg-transparent dark:text-secondary text-secondary-foreground"><Plus /></Button>
        </div>
      </div>
